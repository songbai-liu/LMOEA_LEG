        ...
        function main(Algorithm,Problem)
            ...
            while Algorithm.NotTerminated(Population) 
                ...
                for i = 1 : Problem.N
                    ...
                    if rand > t  %search in the deep improvement representation space
                ...
                %Archive = EnvironmentalSelection_Clustering([Archive,Offspring],2*Problem.N,2*Problem.N);
                %mlp = updateMode(mlp, Archive, V, k, Problem);
            end
        end
    end
end
